...
public class GlobalMincut {
     ...
     */
    public GlobalMincut(edu.princeton.cs.algs4.EdgeWeightedGraph G) {
        V = G.V();
        validate(G);
        minCut(G, 0);
        assert check(G);
     ...
     */
    private void validate(edu.princeton.cs.algs4.EdgeWeightedGraph G) {
     ...
     */
    private void minCut(edu.princeton.cs.algs4.EdgeWeightedGraph G, int a) {
        UF uf = new UF(G.V());
     ...
     */
    private CutPhase minCutPhase(edu.princeton.cs.algs4.EdgeWeightedGraph G, boolean[] marked, CutPhase cp) {
     ...
     */
    private edu.princeton.cs.algs4.EdgeWeightedGraph contractEdge(edu.princeton.cs.algs4.EdgeWeightedGraph G, int s, int t) {
        edu.princeton.cs.algs4.EdgeWeightedGraph H = new edu.princeton.cs.algs4.EdgeWeightedGraph(G.V());
        for (int v = 0; v < G.V(); v++) {
            for (edu.princeton.cs.algs4.Edge e : G.adj(v)) {
                int w = e.other(v);
    ...
    private boolean check(edu.princeton.cs.algs4.EdgeWeightedGraph G) {
        ...
        for (int s = 0, t = 1; t < G.V(); t++) {
            ...
            edu.princeton.cs.algs4.FordFulkerson maxflow = new FordFulkerson(F, s, t);
