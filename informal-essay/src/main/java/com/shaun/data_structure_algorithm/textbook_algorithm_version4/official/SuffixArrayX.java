    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; check && i < s.length(); i++) {
            if (suffix1.index(i) != suffix2.index(i)) {
                edu.princeton.cs.algs4.StdOut.println("suffix1(" + i + ") = " + suffix1.index(i));
                edu.princeton.cs.algs4.StdOut.println("suffix2(" + i + ") = " + suffix2.index(i));
                ...
                edu.princeton.cs.algs4.StdOut.println(ith);
                edu.princeton.cs.algs4.StdOut.println(jth);
                check = false;
            }
        }

        edu.princeton.cs.algs4.StdOut.println("  i ind lcp rnk  select");
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (i == 0) {
                edu.princeton.cs.algs4.StdOut.printf("%3d %3d %3s %3d  %s\n", i, index, "-", rank, ith);
            }
            else {
