...
public class RunLength {
    ...
    public static void expand() { 
        boolean b = false; 
        while (!edu.princeton.cs.algs4.BinaryStdIn.isEmpty()) {
            int run = edu.princeton.cs.algs4.BinaryStdIn.readInt(LG_R);
            for (int i = 0; i < run; i++)
                edu.princeton.cs.algs4.BinaryStdOut.write(b);
            b = !b;
        }
    ...
    public static void compress() { 
        ...
        while (!edu.princeton.cs.algs4.BinaryStdIn.isEmpty()) {
            ...
            if (b != old) {
                edu.princeton.cs.algs4.BinaryStdOut.write(run, LG_R);
                run = 1;
                old = !old;
            }
            else { 
