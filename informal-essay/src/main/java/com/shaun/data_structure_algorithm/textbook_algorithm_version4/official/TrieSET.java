...
public class TrieSET implements Iterable<String> {
    ...
    public Iterable<String> keysWithPrefix(String prefix) {
        edu.princeton.cs.algs4.Queue<String> results = new edu.princeton.cs.algs4.Queue<String>();
        Node x = get(root, prefix, 0);
        collect(x, new StringBuilder(prefix), results);
        return results;
    }

    private void collect(Node x, StringBuilder prefix, edu.princeton.cs.algs4.Queue<String> results) {
        if (x == null) return;
    ...
    public static void main(String[] args) {
        ...
        // print results
        if (set.size() < 100) {
            edu.princeton.cs.algs4.StdOut.println("keys(\"\"):");
            for (String key : set) {
                edu.princeton.cs.algs4.StdOut.println(key);
            }
            edu.princeton.cs.algs4.StdOut.println();
        }

        edu.princeton.cs.algs4.StdOut.println("longestPrefixOf(\"shellsort\"):");
        edu.princeton.cs.algs4.StdOut.println(set.longestPrefixOf("shellsort"));
        edu.princeton.cs.algs4.StdOut.println();

        edu.princeton.cs.algs4.StdOut.println("longestPrefixOf(\"xshellsort\"):");
        edu.princeton.cs.algs4.StdOut.println(set.longestPrefixOf("xshellsort"));
        edu.princeton.cs.algs4.StdOut.println();

        edu.princeton.cs.algs4.StdOut.println("keysWithPrefix(\"shor\"):");
        for (String s : set.keysWithPrefix("shor"))
            edu.princeton.cs.algs4.StdOut.println(s);
        edu.princeton.cs.algs4.StdOut.println();

        edu.princeton.cs.algs4.StdOut.println("keysWithPrefix(\"shortening\"):");
        for (String s : set.keysWithPrefix("shortening"))
            edu.princeton.cs.algs4.StdOut.println(s);
        edu.princeton.cs.algs4.StdOut.println();

        edu.princeton.cs.algs4.StdOut.println("keysThatMatch(\".he.l.\"):");
