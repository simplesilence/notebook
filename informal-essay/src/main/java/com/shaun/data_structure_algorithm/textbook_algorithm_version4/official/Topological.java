 ...
 *  <p>
 *  See {@link edu.princeton.cs.algs4.DirectedCycle}, {@link DirectedCycleX}, and
 *  {@link edu.princeton.cs.algs4.EdgeWeightedDirectedCycle} for computing a directed cycle
...
public class Topological {
    ...
    public Topological(Digraph G) {
        edu.princeton.cs.algs4.DirectedCycle finder = new DirectedCycle(G);
        if (!finder.hasCycle()) {
            edu.princeton.cs.algs4.DepthFirstOrder dfs = new edu.princeton.cs.algs4.DepthFirstOrder(G);
    ...
    public Topological(EdgeWeightedDigraph G) {
        edu.princeton.cs.algs4.EdgeWeightedDirectedCycle finder = new EdgeWeightedDirectedCycle(G);
        if (!finder.hasCycle()) {
            edu.princeton.cs.algs4.DepthFirstOrder dfs = new DepthFirstOrder(G);
            order = dfs.reversePost();
        }
    }
