...
public class Vector { 
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.StdOut.println("   x       = " + x);
        edu.princeton.cs.algs4.StdOut.println("   y       = " + y);

        Vector z = x.plus(y);
        edu.princeton.cs.algs4.StdOut.println("   z       = " + z);

        z = z.times(10.0);
        edu.princeton.cs.algs4.StdOut.println(" 10z       = " + z);

        edu.princeton.cs.algs4.StdOut.println("  |x|      = " + x.magnitude());
        edu.princeton.cs.algs4.StdOut.println(" <x, y>    = " + x.dot(y));
        edu.princeton.cs.algs4.StdOut.println("dist(x, y) = " + x.distanceTo(y));
