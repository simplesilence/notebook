...
public class Transaction implements Comparable<Transaction> {
    ...
    private final edu.princeton.cs.algs4.Date when;     // date
     ...
     */
    public Transaction(String who, edu.princeton.cs.algs4.Date when, double amount) {
    ...
    public Transaction(String transaction) {
        ...
        who    = a[0];
        when   = new edu.princeton.cs.algs4.Date(a[1]);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < a.length; i++)
            edu.princeton.cs.algs4.StdOut.println(a[i]);
        edu.princeton.cs.algs4.StdOut.println();
        
        edu.princeton.cs.algs4.StdOut.println("Sort by date");
        Arrays.sort(a, new WhenOrder());
        for (int i = 0; i < a.length; i++)
            edu.princeton.cs.algs4.StdOut.println(a[i]);
        edu.princeton.cs.algs4.StdOut.println();

        edu.princeton.cs.algs4.StdOut.println("Sort by customer");
        Arrays.sort(a, new WhoOrder());
        for (int i = 0; i < a.length; i++)
            edu.princeton.cs.algs4.StdOut.println(a[i]);
        edu.princeton.cs.algs4.StdOut.println();

        edu.princeton.cs.algs4.StdOut.println("Sort by amount");
