 ...
 *  text stream.
 *  This implementation uses a {@link edu.princeton.cs.algs4.IndexMinPQ} to perform the multiway
 *  merge. 
 *  <p>
...
public class Multiway { 
    ...
    private static void merge(edu.princeton.cs.algs4.In[] streams) {
        ...
        edu.princeton.cs.algs4.IndexMinPQ<String> pq = new IndexMinPQ<String>(n);
        for (int i = 0; i < n; i++)
