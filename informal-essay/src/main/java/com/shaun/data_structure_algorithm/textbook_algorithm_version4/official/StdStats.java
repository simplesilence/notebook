...
public final class StdStats {
   ...
   /**
    ...
    public static void plotPoints(double[] a) {
        ...
        edu.princeton.cs.algs4.StdDraw.setPenRadius(1.0 / (3.0 * n));
        for (int i = 0; i < n; i++) {
            edu.princeton.cs.algs4.StdDraw.point(i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void plotLines(double[] a) {
        ...
        int n = a.length;
        edu.princeton.cs.algs4.StdDraw.setXscale(-1, n);
        edu.princeton.cs.algs4.StdDraw.setPenRadius();
        for (int i = 1; i < n; i++) {
            edu.princeton.cs.algs4.StdDraw.line(i-1, a[i-1], i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.StdOut.printf("       min %10.3f\n", min(a));
        edu.princeton.cs.algs4.StdOut.printf("      mean %10.3f\n", mean(a));
        edu.princeton.cs.algs4.StdOut.printf("       max %10.3f\n", max(a));
        edu.princeton.cs.algs4.StdOut.printf("    stddev %10.3f\n", stddev(a));
        edu.princeton.cs.algs4.StdOut.printf("       var %10.3f\n", var(a));
        edu.princeton.cs.algs4.StdOut.printf("   stddevp %10.3f\n", stddevp(a));
