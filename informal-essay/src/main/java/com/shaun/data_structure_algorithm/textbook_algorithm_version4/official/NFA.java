...
public class NFA { 
    ...
    private edu.princeton.cs.algs4.Digraph graph;     // digraph of epsilon transitions
    ...
    public boolean recognizes(String txt) {
        edu.princeton.cs.algs4.DirectedDFS dfs = new edu.princeton.cs.algs4.DirectedDFS(graph, 0);
        edu.princeton.cs.algs4.Bag<Integer> pc = new edu.princeton.cs.algs4.Bag<Integer>();
        ...
        for (int i = 0; i < txt.length(); i++) {
            ...
            edu.princeton.cs.algs4.Bag<Integer> match = new edu.princeton.cs.algs4.Bag<Integer>();
            for (int v : pc) {
                if (v == m) continue;
