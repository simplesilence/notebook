...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.StdOut.println("seed = " + StdRandom.getSeed());
        for (int i = 0; i < n; i++) {
            edu.princeton.cs.algs4.StdOut.printf("%2d ",   uniform(100));
            edu.princeton.cs.algs4.StdOut.printf("%8.5f ", uniform(10.0, 99.0));
            edu.princeton.cs.algs4.StdOut.printf("%5b ",   bernoulli(0.5));
            edu.princeton.cs.algs4.StdOut.printf("%7.5f ", gaussian(9.0, 0.2));
            edu.princeton.cs.algs4.StdOut.printf("%1d ",   discrete(probabilities));
            edu.princeton.cs.algs4.StdOut.printf("%1d ",   discrete(frequencies));
            edu.princeton.cs.algs4.StdOut.printf("%11d ",  uniform(100000000000L));
            StdRandom.shuffle(a);
            for (String s : a)
